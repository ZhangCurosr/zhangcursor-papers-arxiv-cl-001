...
![](images/f6a591f4d56a55a301f994517bcd4f2090baa6f2047e5891d2106ad3299ca934.jpg)  
...
![](images/29d2e558f842c54e46552d671e26d40443374b4e7c3a44c5709cded7778d94f5.jpg)  
...
$$
\widetilde { \pmb { S } } _ { t - 1 } = \alpha _ { t } \pmb { S } _ { t - 1 } ,\tag{1}
$$

$$
e _ { t } = v _ { t } - \widetilde { S } _ { t - 1 } ^ { \top } k _ { t } ,\tag{2}
$$

$$
\pmb { S } _ { t } = \widetilde { \pmb { S } } _ { t - 1 } + \beta _ { t } \pmb { k } _ { t } \pmb { e } _ { t } ^ { \top } ,\tag{3}
$$

$$
\begin{array} { r } { \mathbf { \boldsymbol { y } } _ { t } = \mathbf { \boldsymbol { S } } _ { t } ^ { \top } \mathbf { \boldsymbol { q } } _ { t } , } \end{array}\tag{4}
$$

where $\alpha _ { t } \in ( 0 , 1 )$ is a data-dependent decay and $\beta _ { t } \in ( 0 , 1 )$ controls the delta update. Equivalently,

$$
\pmb { S } _ { t } = \alpha _ { t } \left( \pmb { I } - \beta _ { t } \pmb { k } _ { t } \pmb { k } _ { t } ^ { \top } \right) \pmb { S } _ { t - 1 } + \beta _ { t } \pmb { k } _ { t } \pmb { v } _ { t } ^ { \top } .\tag{5}
$$
...
$$
\pmb { q } _ { t } = \mathrm { L 2 N o r m } \left( \mathrm { S i L U } \left( \mathrm { S h o r t C o n v } ( \pmb { W } _ { q } \pmb { x } _ { t } ) \right) \right) ,\tag{6}
$$

$$
\pmb { k } _ { t } = \mathrm { L 2 N o r m } \left( \mathrm { S i L U } \left( \mathrm { S h o r t C o n v } ( \pmb { W } _ { k } \pmb { x } _ { t } ) \right) \right) ,\tag{7}
$$

$$
\pmb { v } _ { t } = \mathrm { S i L U } \left( \mathrm { S h o r t C o n v } ( \pmb { W } _ { v } \pmb { x } _ { t } ) \right) .\tag{8}
$$
...
$$
\beta _ { t } = \sigma ( { W _ { \beta } } { \pmb x } _ { t } ) ,\tag{9}
$$

$$
\alpha _ { t } = \exp \left[ - \exp ( A ) \mathrm { s o f t p l u s } ( W _ { \alpha } \mathbf { x } _ { t } + b _ { \alpha } ) \right] .\tag{10}
$$
...
$$
\begin{array} { r } { \begin{array} { r } { \pmb { o } _ { t } = \pmb { W _ { o } } \left[ \sigma \left( \pmb { W _ { z } } \pmb { x } _ { t } \right) \odot \mathrm { R M S N o r m } ( \pmb { y } _ { t } ) \right] . } \end{array} } \end{array}\tag{11}
$$
...
![](images/cf1e8e853c762bae09d523dd1da4add2752e4fd5706d50cc9b3134c6190a422c.jpg)  
...
$$
\widehat { \mathbf { q } } _ { i } ^ { h } = \mathrm { R M S N o r m } ( \mathbf { W } _ { Q } ^ { h } \mathbf { x } _ { i } ) , \qquad \mathbf { k } _ { i } = \mathbf { W } _ { K } \mathbf { x } _ { i } .\tag{12}
$$
...
$$
\widehat { \mathbf { k } } _ { b } = \mathrm { R M S N o r m } \left( \mathrm { A v g P o o l } ( \mathbf { k } _ { p _ { b } : p _ { b } + r - 1 } ) \right) , \qquad 0 \leq b < \left\lfloor \frac { n } { r } \right\rfloor .\tag{13}
$$
...
$$
\mathbf { q } _ { i } ^ { h } = \mathrm { P R o P E } ( \widehat { \mathbf { q } } _ { i } ^ { h } , i ) , \qquad \bar { \mathbf { k } } _ { b } = \mathrm { P R o P E } ( \widehat { \mathbf { k } } _ { b } , p _ { b } ) .\tag{14}
$$
...
$$
\begin{array} { r } { I _ { i b } = \left\{ \begin{array} { l l } { \displaystyle \sum _ { h = 1 } ^ { H } \mathrm { R e L U } \left( \left. { \bf q } _ { i } ^ { h } , \bar { \bf k } _ { b } \right. \right) , } & { p _ { b } + r - 1 \le i , } \\ { \displaystyle - \infty , } & { \mathrm { o t h e r w i s e } , } \end{array} \right. } \end{array}\tag{15}
$$
...
$$
\beta _ { i } = \mathrm { T o p K } _ { K _ { B } } \left( \{ I _ { i b } \} _ { b } \right) , \qquad K _ { B } = \left\lceil \frac { K } { r } \right\rceil .\tag{16}
$$
...
$$
\bar { a } _ { i b } = \mathrm { M a x P o o l } ( { \bf a } _ { i , p _ { b } : p _ { b } + r - 1 } ) , \qquad \hat { \bf a } _ { i } = \frac { \bar { \bf a } _ { i } } { \| \bar { \bf a } _ { i } \| _ { 1 } } .\tag{17}
$$
...
$$
\mathcal { L } _ { \mathrm { K L } } = \frac { 1 } { N } \sum _ { i } D _ { \mathrm { K L } } \left( \hat { \mathbf { a } } _ { i , : } \right| \left| \operatorname { S o f t m a x } ( \mathbf { I } _ { i , : } ) \right) ,\tag{18}
$$
...
$$
S _ { i } = \operatorname { E x p a n d } ( \mathcal { B } _ { i } ) \cup \left\{ r \left[ \frac { i + 1 } { r } \right] , \dots , i \right\} .\tag{19}
$$
...
$$
\mathcal { L } _ { \mathrm { K L } } = \frac { 1 } { N } \sum _ { i } D _ { \mathrm { K L } } ( \hat { \mathbf { a } } _ { i , \mathcal { B } _ { i } }  \operatorname { S o f t m a x } ( \mathbf { I } _ { i , \mathcal { B } _ { i } } ) ) .\tag{20}
$$
...
<table><tr><td></td><td colspan="2">Knowledge</td><td colspan="2">STEM</td><td>Reasoning</td><td>Multilingual</td><td colspan="2">Code</td><td></td></tr><tr><td>Method</td><td>MMLU-Pro</td><td>SuperGPQA</td><td>MATH</td><td>GSM8K</td><td>BBH</td><td>MMMLU</td><td>EvalPlus</td><td>MultiPL-E</td><td>Avg.</td></tr><tr><td>Full Attn</td><td>72.9</td><td>51.7</td><td>69.8</td><td>91.0</td><td>90.4</td><td>81.8</td><td>70.8</td><td>78.4</td><td>75.9</td></tr><tr><td>w/QSA</td><td>73.7</td><td>52.1</td><td>71.6</td><td>92.2</td><td>91.6</td><td>81.1</td><td>72.3</td><td>79.8</td><td>76.8</td></tr></table>
...
<table><tr><td colspan="4"></td><td colspan="4">MRCR</td><td rowspan="2">1M</td><td rowspan="2">Avg.</td></tr><tr><td>Method</td><td>≤128K</td><td>128–256K</td><td>256-512K</td><td>512K-1M</td><td>128K</td><td>256K</td><td>512K</td></tr><tr><td>Full Attn</td><td>99.84</td><td>99.81</td><td>97.65</td><td>90.08</td><td>97.14</td><td>94.20</td><td>30.66</td><td>20.71</td><td>78.76</td></tr><tr><td>w/QSA</td><td>99.89</td><td>99.62</td><td>98.95</td><td>93.00</td><td>95.98</td><td>93.00</td><td>40.53</td><td>26.44</td><td>80.93</td></tr></table>
...
<table><tr><td>Method</td><td>MT-Bench</td><td>GSM8K</td><td>MATH</td><td>HumanEval MBPP</td><td></td><td>Avg.</td></tr><tr><td>Full Attn</td><td>3.44</td><td>4.19</td><td>4.29</td><td>4.24</td><td>4.12</td><td>4.06</td></tr><tr><td>w/ QSA</td><td>3.47</td><td>4.20</td><td>4.30</td><td>4.26</td><td>4.13</td><td>4.07</td></tr></table>
...
![](images/d816003ff43fbc71dd6ccfd8af30be5ddeeb3af40ec25328609edc7ad52db259.jpg)  
...
![](images/436e61e425e89457c918507cf7da8cddd73c171af821e53333799f3da0d9142a.jpg)  
(last 16K chunk, BS = 1)

![](images/e6ba8ddac9357ec6a16794235f093fdff97f1a2344ed34bc60c5e865f704e0e4.jpg)  
(b) Indexer Decode  
(BS = 4, next\_n = 4)
...
![](images/08cab27b73dc5938efdc51b6e1f35d960acc8ae164535a604724b5c68b4a71b5.jpg)  
(d) Attention Decode  
(BS = 4, next\_n = 4)  
...
$$
\pmb { x } ^ { ( \ell ) } = \sum _ { i = 1 } ^ { n _ { r } } h _ { i } \pmb { R } _ { i } ^ { ( \ell ) } .\tag{21}
$$

The block output $\pmb { y } ^ { ( \ell ) }$ is then written back to a single branch, chosen round-robin by depth:

$$
\pmb { R } _ { i } ^ { ( \ell + 1 ) } = \pmb { R } _ { i } ^ { ( \ell ) } + \mathbf { 1 } \left[ i = \ell \bmod n _ { r } \right] \pmb { y } ^ { ( \ell ) } .\tag{22}
$$
...
$$
\pmb { x } ^ { ( \ell ) } = \pmb { H } _ { \mathrm { m i x } } ^ { \top } \pmb { R } ^ { ( \ell ) } ,\tag{23}
$$

$$
\begin{array} { r } { \pmb { y } ^ { ( \ell ) } = \mathcal { F } ^ { ( \ell ) } \left( \mathrm { N o r m } \left( \pmb { x } ^ { ( \ell ) } \right) \right) , } \end{array}\tag{24}
$$

$$
\pmb { R } ^ { ( \ell + 1 ) } = \pmb { H } _ { \mathrm { r e s } } \pmb { R } ^ { ( \ell ) } + \pmb { H } _ { \mathrm { c o m b i n e } } \pmb { y } ^ { ( \ell ) \top } ,\tag{25}
$$

with $H _ { \mathrm { m i x } } , H _ { \mathrm { c o m b i n e } } \in \mathbb { R } ^ { n _ { r } }$ and $H _ { \mathrm { r e s } } \in \mathbb { R } ^ { n _ { r } \times n _ { r } }$ . In the notation of HC these are $A _ { m }$ B and $A _ { r }$ . The three operators are predicted from the residual state. Let $\overline { { \pmb { R } } } = \mathrm { n o r m } ( \pmb { R } ^ { ( \ell ) } )$ be a normalized view of the branches. Each operator is then the sum of a static term and a data-dependent term:

$$
H _ { \mathrm { m i x } } = H _ { \mathrm { m i x } } ^ { \mathrm { s } } + \lambda _ { m } \odot \phi \left( \overline { { \pmb { R } } } \pmb { W } _ { m } \right) ,\tag{26}
$$

$$
H _ { \mathrm { c o m b i n e } } = H _ { \mathrm { c o m b i n e } } ^ { \mathrm { s } } + \lambda _ { c } \odot \phi \left( \overline { { { \bf R } } } { \bf W } _ { c } \right) ,\tag{27}
$$

$$
H _ { \mathrm { r e s } } = H _ { \mathrm { r e s } } ^ { \mathrm { s } } + \lambda _ { r } \odot \phi \left( \overline { { \boldsymbol { R } } } \boldsymbol { W } _ { r } \right) ,\tag{28}
$$

where $H _ { \star } ^ { \mathrm { s } }$ is a learnable static term, W<sub>⋆</sub> projects the normalized residual, ϕ is an activation function, and $\lambda _ { \star }$ is a learnable scale, with ⋆ standing for any of the three operators. HC uses $\phi =$ tanh with $\lambda ,$ initialized to 0.01; mHC (Xie et al., 2025) uses a sigmoid and additionally constrains $H _ { \mathrm { r e s } }$ to a manifold of doubly stochastic matrices. Specifically, we set the static terms to $H _ { \mathrm { m i x } } ^ { \mathrm { s } } = e _ { \ell \mathrm { m o d } n _ { r } } , H _ { \mathrm { c o m b i n e } } ^ { \mathrm { s } } = 1$ , and $\pmb { H } _ { \mathrm { r e s } } ^ { \mathrm { s } } \doteq \pmb { I }$ . With $W _ { \star } = \mathbf { 0 } .$ , this initialization starts the widened network exactly at the pre-norm baseline; with $\mathbf { \partial } \lambda _ { \star } = \mathbf { 0 }$ throughout, the operators stay static and the widened stream costs no extra computation, which recovers the simplified AltUp variant above.
...
Table 5: Residual read/write ablation on 25B-A3B MoE models trained on 560B tokens. The benchmarks and the evaluation pipeline are those of §2.1.1. All widened variants use ${ n _ { r } } = 4$ branches; static is the case λ<sub>⋆</sub> = 0 of Eq. (26)–(28), dynamic its data-dependent counterpart.
<table><tr><td rowspan="2">Residual</td><td rowspan="2">Loss</td><td colspan="3">Knowledge</td><td colspan="2">STEM</td><td>Reasoning</td><td>Multilingual</td><td colspan="2">Code</td><td></td></tr><tr><td>MMLU</td><td>MMLU-Pro</td><td>SuperGPQA</td><td>MATH</td><td>GSM8K</td><td>BBH</td><td>MMMLU</td><td>EvalPlus</td><td>MultiPL-E</td><td> $\operatorname { A v g } .$ </td></tr><tr><td>Pre-norm</td><td>1.617</td><td>64.29</td><td>38.40</td><td>21.78</td><td>53.92</td><td>77.41</td><td>64.73</td><td>51.26</td><td>49.25</td><td>37.15</td><td>50.91</td></tr><tr><td>mHC (static)</td><td>1.596</td><td>64.62</td><td>43.69</td><td>22.20</td><td>55.08</td><td>78.05</td><td>65.42</td><td>52.78</td><td>49.59</td><td>40.94</td><td>52.49</td></tr><tr><td>mHC (dynamic)</td><td>1.594</td><td>66.11</td><td>45.84</td><td>24.20</td><td>59.54</td><td>78.51</td><td>66.01</td><td>56.61</td><td>52.16</td><td>41.30</td><td>54.47</td></tr><tr><td>GR</td><td>1.590</td><td>66.69</td><td>46.02</td><td>23.80</td><td>61.18</td><td>78.20</td><td>66.54</td><td>56.19</td><td>51.36</td><td>42.00</td><td>54.66</td></tr></table>
...
$$
\mathrm { G a t e d N o r m } ( { \boldsymbol u } ) = \mathrm { R M S N o r m } ( { \boldsymbol u } ) \odot \sigma \left( W _ { \mathrm { 2 } } \mathrm { S i L U } \left( W _ { \mathrm { 1 } } \mathrm { R M S N o r m } ( { \boldsymbol u } ) \right) \right) ,\tag{29}
$$
...
$$
\begin{array} { r } { \widehat { \pmb { R } } _ { i } = \mathrm { R M S N o r m } \left( \pmb { R } _ { i } ; \gamma _ { i } \right) , \qquad i = 1 , \ldots , n _ { r } , } \end{array}\tag{30}
$$
...
$$
\begin{array} { r } { G = \mathrm { u n v e c } ~ \sigma \left( W _ { u } \mathrm { S i L U } \left( \frac { 1 } { n _ { r } } W _ { d } \mathrm { v e c } ( \widehat { \pmb { R } } ) \right) \right) \in \mathbb { R } ^ { n _ { r } \times d } , } \end{array}\tag{31}
$$

$$
{ \pmb x } = \frac { 1 } { n _ { r } } \sum _ { i = 1 } ^ { n _ { r } } { \pmb G } _ { i } \odot \widehat { { \pmb R } } _ { i } ,\tag{32}
$$
...
$$
\begin{array} { r } { \pmb { s } = 2 \sigma \left( \frac { 1 } { n _ { r } } W _ { w } \mathrm { v e c } ( \widehat { \pmb { R } } ) \right) \in \mathbb { R } ^ { n _ { r } } , } \end{array}\tag{33}
$$

$$
\pmb { R } _ { i } ^ { \prime } = \pmb { R } _ { i } + s _ { i } \pmb { y } ,\tag{34}
$$
...
Tab. 6 compares both variants against GR in our setting, a 28-layer model $( L = 5 6$ sublayers), each with and without GN. Full AttnRes is the strongest setting of that family and lands level with GR at 1.762, while summarizing blocks costs 0.008 at $S = 2$ and 0.011 at $S = 4$ . The same ordering holds deeper: at 48 layers, Block AttnRes at $S = 4$ reaches 1.711 against 1.707 for GR. GN lowers the loss at every setting, by 0.004–0.005 on AttnRes and by 0.002 on the plain pre-norm baseline. The gate helps more when the input a sublayer reads is more complex, which is the same gate GR carries inside its read.
...
<table><tr><td>Residual design</td><td>Loss</td><td>Loss + GN</td></tr><tr><td>Pre-norm residual</td><td>1.789</td><td>1.787-0.002</td></tr><tr><td>Block AttnRes,  $S = 4$ </td><td>1.773</td><td>1.768-0.005</td></tr><tr><td>Block AttnRes,  $S = 2$ </td><td>1.770</td><td>1.766-0.004</td></tr><tr><td>Full AttnRes</td><td>1.762</td><td>1.758-0.004</td></tr><tr><td>GR  $( n _ { r } = 4 )$ </td><td></td><td>1.762</td></tr></table>
...
$$
R _ { c } ^ { ( v ) } = R _ { c } ^ { ( 0 ) } + \sum _ { u < v } s _ { c } ^ { ( u ) } y ^ { ( u ) } ,\tag{35}
$$
...
$$
{ { a } _ { u  v } } = \frac { 1 } { { { n } _ { r } } } \sum _ { c = 1 } ^ { { { n } _ { r } } } { { { G } _ { c } ^ { ( v ) } } \odot { \gamma } _ { c } \odot \frac { { { s } _ { c } ^ { ( u ) } } { { y } ^ { ( u ) } } } { \operatorname { r m s } ( { { R } _ { c } ^ { ( v ) } } ) } } ,\tag{36}
$$
...
![](images/19413e73393f7f5c7be3f05e164a0342be69454b9206458373b4b3d645ca6fdd.jpg)  
...
$$
\pi _ { u v } = \frac { \lVert { \pmb a } _ { u  v } \rVert } { \sum _ { u ^ { \prime } < v } \lVert { \pmb a } _ { u ^ { \prime }  v } \rVert } ,\tag{37}
$$
...
Motivation. Embedding-based memory ofers a complementary dimension for scaling model capacity (Jordan & Koszarsky, 2024; Google DeepMind, 2025; RWKV Community, 2025; Gemma Team, 2026; Sadhukhan et al., 2026; Tseng & De Sa, 2026). N-gram embeddings further generalize unigram lookup by conditioning memory retrieval on local context rather than token identity alone (Huang et al., 2021; Roy et al., 2022; Huang et al., 2025; Yu et al., 2025; Cheng et al., 2026; Liu et al., 2026; Chen et al., 2026). Concretely, short n-grams ending at each token serve as keys into embedding tables, and the retrieved vectors augment the corresponding token representation. N-gram memory scales capacity with negligible additional per-token FLOPs, while deterministic addressing enables host-memory ofloading and asynchronous prefetching. In this section, we systematically study the key architectural choices for N-gram embedding. We use multi-head hashing for embedding lookup (Roy et al., 2022; Huang et al., 2025). The embeddings are further injected into residual stream through contextual gating mechanism (Cheng et al., 2026). We use 300 tokens per active parameter (TPP) throughout experiments.
...
![](images/e0acd5ee667dbfb03ae706e8a1cdda2c42a0a264440630b1d9a2dbb529c4beac.jpg)  
(b) Ramped batch size.  
...
![](images/019204a0ddb41a866cb8d44dcd197a78e76c9572fb012711e646c7d0b35a00b2.jpg)  
(a) Training loss.

![](images/6979ea729bee56155d07c58316d55f9befb4099cc541b9806f5b16214954d2f1.jpg)  
(b) Gradient norm.  
...
<table><tr><td></td><td></td><td></td><td colspan="3">Knowledge</td><td colspan="2">STEM</td><td>Reasoning</td><td>Multilingual</td><td></td></tr><tr><td>Setting</td><td>B</td><td>η</td><td>MMLU</td><td>MMLU-Pro</td><td>SuperGPQA</td><td>MATH</td><td>GSM8K</td><td>BBH</td><td>MMMLU</td><td>Avg.</td></tr><tr><td>New fit, predicted optimum</td><td>8.4M</td><td> $1 . 7 6 \times 1 0 ^ { - 3 }$ </td><td>73.84</td><td>48.35</td><td>29.31</td><td>49.98</td><td>80.89</td><td>73.25</td><td>68.23</td><td>60.55</td></tr><tr><td>New fit,  $\eta \div { \sqrt { 2 } }$ </td><td>8.4M</td><td> $1 . 2 4 \times 1 0 ^ { - 3 }$ </td><td>73.59</td><td>47.00</td><td>28.10</td><td>48.92</td><td>77.48</td><td>72.00</td><td>66.88</td><td>59.14</td></tr><tr><td>New fit,  $\eta \times \sqrt { 2 }$ </td><td>8.4M</td><td> $2 . 4 9 \times 1 0 ^ { - 3 }$ </td><td>73.84</td><td>46.92</td><td>28.04</td><td>49.58</td><td>80.06</td><td>73.82</td><td>68.46</td><td>60.10</td></tr><tr><td>New fit,  $B \times 1 . 2 5$ </td><td>10.5M</td><td> $2 . 0 1 \times 1 0 ^ { - 3 }$ </td><td>73.73</td><td>48.51</td><td>28.52</td><td>49.32</td><td>80.06</td><td>72.58</td><td>67.72</td><td>60.06</td></tr><tr><td>Qwen3.5 recipe</td><td>4.2M</td><td> $6 . 8 \times 1 0 ^ { - 4 }$ </td><td>71.23</td><td>45.35</td><td>25.67</td><td>45.54</td><td>74.32</td><td>69.54</td><td>63.19</td><td>56.41</td></tr></table>
...
![](images/63eadf08c66f2d4705a1561847b03c8a0d24704e3c17f588e8e45a1ac066dc95.jpg)  
(a) 2× optimal learning rate.

![](images/d002f4d9c7fdd71b87fee28a330be3faf12fd67275166aad1beb78206217dc7d.jpg)  
...
![](images/084e606d94db4c9dc40d5bbb345c51314c9a8f17ea98c8313ddb623fa7a36284.jpg)  
(a) Training loss.

![](images/fe183c7d4fb807b528e14398851b0fd01b57c2fbd2eaa6df54fba5e3f3b262a0.jpg)  
(b) Pre-clip gradient norm.

![](images/1248a84d7910c1f56926e134c35945356d550f4a57ffb5bedfc463b7811effb3.jpg)  
...
![](images/738d9e6a5e3c2a2da30452e744e9f2a3cb84a68a2950269eea660ad7e18517f3.jpg)
...
![](images/60a17e41a5179a8f87e027fd8a5b655d0198c805c15feb21defb9c424cadc13a.jpg)  
...
• Coding Tasks: EvalPlus (Liu et al., 2023) (0-shot; the average over HumanEval (Chen et al., 2021), MBPP (Austin et al., 2021), HumanEval+ and MBPP+), MultiPL-E (Cassano et al., 2023) (0-shot; Python, C++, Java, PHP, TypeScript, C#, Bash, JavaScript), SWEBench-Pretrain, a pre-training variant of SWE-bench (Jimenez et al., 2024)<sup>1</sup>.
...
<sup>1</sup>We draw inspiration from Xia et al. (2024) to construct SWEBench-Pretrain. In detail, we feed base models the problem descriptions, relevant code files and ask models to produce dif patches. The sequence similarities between golden and model-generated patches are calculated as the reported scores.
...
Contributors<sup>2</sup>: Bochao Mao, Chengruidong Zhang, Fan Zhou, Hao Luo, Haofeng Huang, Haoran Lian, Haoyan Huang, Hongqing Chen, Jianwei Zhang, Jing Xu, Junjie Wang, Langshi Chen, Liangyu Wang, Linlang Jiang, Man Yuan, Minmin Sun, Peng Jin, Siqi Zhang, Siyu Wang, Xingzhang Ren, Yakai Wang, Yi Zhang, Yiming Dong, Yizhong Cao, Yubo Ma, Yunfei Mao
...
Keller Jordan and Braden Koszarsky. modded-nanogpt (value embeddings from nanogpt speedrun). github.com/KellerJordan/modded-nanogpt, 2024.
